...
const MagicWandIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M15 4V2" /><path d="M15 10V8" /><path d="M12.5 7H17.5" /><path d="M20 5.5V2.5" /><path d="M4 15l4.9-4.9" /><path d="M13 22l4.9-4.9" /><path d="M2 22l2.5-2.5" /><path d="M19.5 6.5L22 4" /><path d="M9.8 14.2l-2.5 2.5" /><path d="M14.2 9.8l2.5-2.5" /><path d="M7.3 2.3L5.5 4" /><path d="M4 5.5L2.3 7.3" />
  </svg>
);
          ...
          {imageUrl && !isLoading && (
            <div className="w-full flex flex-col gap-4 items-center">
              <div className="w-full bg-black/30 p-4 rounded-2xl border border-white/10">
                <img src={imageUrl} alt={prompt} className="rounded-xl w-full h-auto object-contain" />
              </div>
              <button
